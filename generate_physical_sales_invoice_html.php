...
<div class="invoice-container">
    ...
    <div class="invoice-footer">
        <p><strong>Payment Method:</strong> <?php echo ucwords(str_replace('_', ' ', $sale['payment_method'])); ?></p>
        ...
        <?php if ($sale['bank_transfer_amount'] > 0): ?>
            <p><strong>Bank Transfer:</strong> LKR <?php echo number_format($sale['bank_transfer_amount'], 2); ?></p>
        <?php endif; ?>
    ...
    <div class="invoice-buttons">
        ...
        <a href="physical_sales_details.php?id=<?php echo $sale['id']; ?>" class="btn btn-default">
            <i class="fas fa-eye"></i> Back to Sale Details
        </a>
