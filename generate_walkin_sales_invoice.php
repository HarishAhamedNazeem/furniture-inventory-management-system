<?php
$page_title = 'Walk-in Sales Invoice';
...
<head>
    ...
    <title>Walk-in Sales Invoice - <?php echo htmlspecialchars($sale['sale_number']); ?></title>
    ...
    <div class="container">
        <div class="invoice-container">
            ...
            <div class="invoice-buttons">
                <button onclick="window.print()" class="btn-admin">
